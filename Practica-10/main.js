...
async function datosAxios() {
  try {
    ...
    data.forEach((usuario) => {
      ...
      <div
  class="flex flex-col bg-neutral-300 w-full h-60 animate-pulse rounded-xl p-4 gap-4"
>
...
>
  ...
  <div class="top-16 z-10 flex items-center flex-col gap-4 px-5 py-5">
    ...
    <div class="flex items-center flex-col">
      <p  class="text-black font-Roboto-md">${usuario.name}</p>
      <p  class="text-black font-Roboto-md">${usuario.username}</p>
      <p  class="text-black font-Roboto-md">${usuario.email}</p>
      <p  class="text-black font-Roboto-md">${usuario.company.name}</p>
    ...
    contenedor.innerHTML += `
      <div class="flex flex-col bg-neutral-300 w-full h-60 animate-pulse rounded-xl p-4 gap-4 md:col-start-2" >
          <div class="bg-neutral-400/50 w-full h-32 animate-pulse rounded-md"></div>
